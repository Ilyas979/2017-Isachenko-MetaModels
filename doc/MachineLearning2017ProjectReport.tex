...
In this paper we propose using local spline approximation for feature extraction. In this setup features are knots and parameters of optimal cubic splines. We compare this method with other well-known methods for extracting features from time series.
